...
export default function PopularMovies() {
    ...
    async function getMovies() {
        const res = await getListMoviesAndTVsAndPeopleContext('movie', 'popular');
    ...
    return (
        <>
            <CustomeHeaderSections title="Popular Movies" type='Movie' valType={filtered} setType={setSearchItem} />
