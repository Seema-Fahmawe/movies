...
export default function Nowplaying() {
  ...
  async function getMovies() {
    const res = await getListMoviesAndTVsAndPeopleContext('movie', 'now_playing');
  ...
  return (
    <>
      ...
      <CustomeHeaderSections title="Now Playing Movies" type='Movie' valType={filtered} setType={setSearchItem} />
